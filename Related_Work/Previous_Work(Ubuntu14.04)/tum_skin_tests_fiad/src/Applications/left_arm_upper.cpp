...
{
	ros::init(argc,argv,"left_arm_upper");
	ros::NodeHandle nh;

	ros::Publisher id_pub = nh.advertise<std_msgs::Int32MultiArray>("ids_left_arm_upper",1000);
	ros::Publisher range_pub = nh.advertise<std_msgs::Float32MultiArray>("range_left_arm_upper",1000);
	ros::Publisher force_pub = nh.advertise<std_msgs::Float32MultiArray>("force_left_arm_upper",1000);
	...
	while(ros::ok())
	{
		...
		if (range1>=0.2)
			{
				ROS_INFO_STREAM("Left cell_1 is being touched!!!"); 
			}
		if (range2>=0.2)
			{
				ROS_INFO_STREAM("Left cell_2 is being touched!!!"); 
			}
		if (range3>=0.2)
			{
				ROS_INFO_STREAM("Left cell_3 is being touched!!!"); 
			}
		if (range4>=0.2)
			{
				ROS_INFO_STREAM("Left cell_4 is being touched!!!"); 
			}
		if (range5>=0.2)
			{
				ROS_INFO_STREAM("Left cell_5 is being touched!!!"); 
			}
		if (range6>=0.2)
			{
				ROS_INFO_STREAM("Left cell_6 is being touched!!!"); 
			}
		if (range7>=0.2)
			{
				ROS_INFO_STREAM("Left cell_7 is being touched!!!"); 
			}
		if (range8>=0.2)
			{
				ROS_INFO_STREAM("Left cell_8 is being touched!!!"); 
			}
		if (range9>=0.2)
			{
				ROS_INFO_STREAM("Left cell_9 is being touched!!!"); 
			}
		if (range10>=0.2)
			{
				ROS_INFO_STREAM("Left cell_10 is being touched!!!"); 
			}
		if (range11>=0.2)
			{
				ROS_INFO_STREAM("Left cell_11 is being touched!!!"); 
			}
		if (range12>=0.2)
			{
				ROS_INFO_STREAM("Left cell_12 is being touched!!!"); 
			}
		if (range13>=0.2)
			{
				ROS_INFO_STREAM("Left cell_13 is being touched!!!"); 
			}
		if (range14>=0.2)
			{
				ROS_INFO_STREAM("Left cell_14 is being touched!!!"); 
			}
		if (range15>=0.2)
			{
				ROS_INFO_STREAM("Left cell_15 is being touched!!!"); 
			}
		if (range16>=0.2)
			{
				ROS_INFO_STREAM("Left cell_16 is being touched!!!"); 
			}
