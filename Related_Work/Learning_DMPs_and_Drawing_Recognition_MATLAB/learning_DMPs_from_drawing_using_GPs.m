%%% Learning DMPs from drawings using GPs

%recordTrajectory;
clear;
load('./Drawings/Circles/circle1.mat');
...
% save the model
save('./Models/Circle/circle_m1.mat', 'm1');
save('./Models/Circle/circle_m2.mat', 'm2');
save('./Models/Circle/circle_D1.mat', 'D1');
save('./Models/Circle/circle_D2.mat', 'D2');